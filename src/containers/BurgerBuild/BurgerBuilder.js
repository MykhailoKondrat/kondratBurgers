...
const mapDispatchToProps = dispatch => {
	return{
		onIgredeintAdded: (ingName) => dispatch ({type:actionTypes.ADD_INGREDIENT, ingredientName: ingName}),
		onIgredeintRemoved: (ingName) => dispatch ({type:actionTypes.REMOVE_INGREDIENT, ingredientName: ingName}),
	}
}
